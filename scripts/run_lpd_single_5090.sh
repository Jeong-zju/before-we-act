...
export LPD_EXPERIMENT_SLUG="${LPD_EXPERIMENT_SLUG:-lpd_static_dino_act_moe}"
export LPD_CONFIG="${LPD_CONFIG:-${FE_ROOT}/configs/static_act/lpd_static_dino_act_moe.yaml}"
export LPD_CHECKPOINT="${LPD_CHECKPOINT:-${FE_ROOT}/checkpoints/lpd_static_dino_act_moe/checkpoint_080000.pt}"
