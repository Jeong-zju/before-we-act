"""Train and evaluate the accepted proprioceptive baselines."""
    ...
    with TrainingProgress(
        ...
        if trains_world_model:
            ...
            (args.output_dir / "outcome_label_stats.json").write_text(
                json.dumps(
                    {
                        "format_version": "wam.baselines.outcome-labels/1",
                        "source_split": "train",
        ...
        for model_name in model_names:
            ...
            if model_name != "action_prior":
                ...
                calibration_payload = {
                    "format_version": "wam.baselines.outcome-calibration/1",
                    "model": model_name,
            ...
            save_file(
                ...
                metadata={
                    "baseline": model_name,
                    "format_version": "wam.baselines/2",
                },
            )
