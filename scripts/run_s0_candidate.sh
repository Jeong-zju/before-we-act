...
export UV_CACHE_DIR="${S0_BASE_REPO}/.uv-cache"
export UV_PROJECT_ENVIRONMENT="${S0_BASE_REPO}/.venv"
export ROBOFACTORY_ROOT="${ROBOFACTORY_ROOT:-$(cd "${S0_BASE_REPO}/.." && pwd)/RoboFactory}"
