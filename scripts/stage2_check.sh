...
PYTHONPATH=. python data/collect_stage2.py --mode scripted --num_episodes 20 --out_dir datasets/stage2/check_scripted --seed_start 70000 --noise_std 0.0 --randomize 1

echo "[4/9] Validate scripted check data"
PYTHONPATH=. python data/validate_stage2_dataset.py --data_dir datasets/stage2/check_scripted

echo "[5/9] Collect noisy check data"
rm -rf datasets/stage2/check_noisy
PYTHONPATH=. python data/collect_stage2.py --mode noisy --num_episodes 30 --out_dir datasets/stage2/check_noisy --seed_start 71000 --noise_std 10.0 --randomize 1

echo "[6/9] Validate noisy check data"
PYTHONPATH=. python data/validate_stage2_dataset.py --data_dir datasets/stage2/check_noisy
...
PYTHONPATH=. python data/split_stage2_dataset.py --sources datasets/stage2/check_scripted datasets/stage2/check_noisy --out_root datasets/stage2/check_split --train_ratio 0.8 --val_ratio 0.1 --seed 0 --copy 1

echo "[9/9] Dataset window smoke test"
PYTHONPATH=. python data/stage2_dataset.py --data_dir datasets/stage2/check_split/train --window 16
