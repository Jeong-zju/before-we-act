#!/usr/bin/env python3
"""Evaluate one S2-R4 local control on the fixed held-out split."""
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    if (
        ...
        raise ValueError("S2-R4 checkpoint method differs from runtime config")
    ...
    if artifact_sha256 != saved.get("future_artifacts_sha256"):
        raise ValueError("S2-R4 checkpoint PCA/statistics identity changed")
        ...
        for task_id, indices in selected.items():
            ...
            for batch_index, raw_batch in enumerate(loader, start=1):
                ...
                progress = {
                    ...
                    "program": "evaluate_s2_r4_future_predictor.py",
    ...
    comparison_contract = {
        ...
        "r3_w1_parent_sha256": _mapping(
            saved, "initialization_parent"
        )["r3_w1_checkpoint_sha256"],
