...
from before_we_act.b3_n1_r1 import _constructor_config
...
def main() -> None:
    ...
    _metadata, n1_episodes = load_n1_metadata(args.n1_cache)
    ...
    model = B0HPolicy(**_constructor_config(payload)).to(device)
