...
def init(args):
    ...
    atomic_json(
        manifest,
        {
            ...
            "tmux_sessions": {candidate: f"bwa-r12r1-{candidate}" for candidate in CANDIDATES},
            "shared_data": "/workspace/datasets/robofactory_multitask",
            "shared_hf_cache": "/workspace/.cache/huggingface",
            "shared_action_cache": "/workspace/bwa_runs/shared/r12_causal_coldstart_action_cache.pt",
            "protocol_variant": "causal_lag1_coldstart_v1",
            "formal_updates": 20_000,
            ...
            "acceptance_rules": [
                ...
                "causal lag-1 action history and explicit t=0/1/2 cold-start cache",
                "runtime contains no Stereo-CoRE/PAIR/ARCA/forced-role implementation or checkpoint",
                "formal 20000 causal/cold-start updates complete; offline control-cycle smoke is finite",
