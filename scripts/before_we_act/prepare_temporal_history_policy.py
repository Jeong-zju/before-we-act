...
from before_we_act.temporal_history_data import (  # noqa: E402
    ACTION_HORIZON,
    EFFECTIVE_BATCH,
...
def contract(args: argparse.Namespace) -> None:
    ...
    print("TEMPORAL_CONTRACT_FROZEN")
...
def f0(args: argparse.Namespace) -> None:
    ...
    print("TEMPORAL_PREFLIGHT_PASSED")
...
def cursor(args: argparse.Namespace) -> None:
    ...
    print("TEMPORAL_CURSOR_REPLAY_PASSED")
