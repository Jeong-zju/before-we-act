...
from scripts.before_we_act.analyze_predictive_team_belief import load_training, offline_gate
from scripts.before_we_act.summarize_team_belief_validation import (
    EXPECTED_BASELINES,
...
def prepare(
    ...
    *,
    ...
    if sha256_file(temporal_checkpoint) != EXPECTED_BASELINES["b0h"][
        "checkpoint_sha256"
    ]:
    ...
    return {
        ...
        "b0h_checkpoint": str(temporal_checkpoint.resolve()),
        "b0h_checkpoint_sha256": sha256_file(temporal_checkpoint),
