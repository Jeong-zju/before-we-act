...
from before_we_act.b3_n1_r1 import load_split, split_by_episode_key
from before_we_act.b3_n2_data import B3N2Dataset
from before_we_act.b3_n2_training import B3N2Experiment
from before_we_act.step2_temporal_data import sha256_file
from before_we_act.train_b3_n2 import (
...
def measure(
    ...
    model = B3N2Experiment(config_from_contract(contract)).to(device).eval()
