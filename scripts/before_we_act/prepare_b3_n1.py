...
from before_we_act.b3_n1_data import CAPACITY_CANDIDATES, FUTURE_OFFSETS
from before_we_act.step2_temporal_data import SIX_TASKS, load_step2_episodes, sha256_file
...
def main() -> None:
    args = parse_args()
    contract = json.loads(args.step2_contract.read_text())
    ...
    metadata = {
        ...
        "source_step2_contract": str(args.step2_contract.resolve()),
        "source_step2_contract_sha256": sha256_file(args.step2_contract),
