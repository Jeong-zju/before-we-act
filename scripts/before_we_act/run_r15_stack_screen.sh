...
case "$LABEL" in
  w12_role_query_view_dedup_*|role_query_view_dedup_act_temporal_ensemble)
    EXECUTION_DETAIL="role-conditioned spatial queries plus bit-exact view deduplication; W10 temporal ensemble decay=0.01"
    ;;
