...
def test_pipeline_freezes_a_checked_safe_directory_source_commit() -> None:
    ...
    launcher = (root / "scripts/before_we_act/run_predictive_team_belief_pipeline.sh").read_text(
        encoding="utf-8"
    )
...
def test_pipeline_requires_frozen_owner_authorization_and_gates_validation20() -> None:
    ...
    assert "BWA_TEAM_BELIEF_AUTHORIZE_VALIDATION_DIAGNOSTIC" in launcher
