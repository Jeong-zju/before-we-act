...
from before_we_act.b3_n1_data import N1Episode
from before_we_act.b3_n2_data import B3N2PairedBatchSampler
from before_we_act.step2_temporal_data import SIX_TASKS


def _episodes() -> tuple[list[N1Episode], dict[str, str]]:
    episodes = []
    split = {}
    offset = 0
