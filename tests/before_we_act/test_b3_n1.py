...
from before_we_act.b3_n1_data import CAPACITY_CANDIDATES  # noqa: E402
from before_we_act.b3_n1_model import (  # noqa: E402
    N1ActionProbeSet,
    N1RawSignalModel,
...
def model():
    return N1RawSignalModel(d_model=32, temporal_layers=1, heads=4, dropout=0.0)
...
def test_matched_probe_heads_have_identical_parameter_counts():
    probes = N1ActionProbeSet(d_model=32)
    counts = {
