...
PREPARE = ROOT / "scripts/prepare_s4_r7_shared.sh"
    ...
    environment.update(
        {
            ...
            "S4_R7_RUN_ROOT": str(run_root),
            "S4_R7_READY_FILE": str(run_root / "shared.ready"),
            "S4_R7_FAILED_FILE": str(run_root / "shared.failed"),
            "S4_R7_USE_S0_PREP": "1",
            "S4_R7_HF_TOKEN_FIFO": str(fifo),
            "S4_R7_ROBOFACTORY_ROOT": str(tmp_path / "RoboFactory"),
            "S4_R7_RF_PYTHON": str(tmp_path / "RoboFactory/.venv/bin/python"),
