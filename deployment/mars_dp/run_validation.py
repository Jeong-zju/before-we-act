...
def main():
    ...
    for i,task in enumerate(TASKS):
        ...
        cmd=[sys.executable,"-m","deployment.mars_dp.evaluate","--checkpoint",a.checkpoint,"--task",task,"--robofactory-root",a.robofactory_root,"--output",str(out),"--episodes",str(episodes),"--seed-start",str(seed),"--max-steps",str(max_steps),"--inference-steps","20","--replan-interval","6"]
