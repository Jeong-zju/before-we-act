...
def build_policy(device: str | torch.device = "cpu"):
    ...
    encoder = TimmObsEncoder(
        ...
        share_rgb_model=False, imagenet_norm=True, feature_aggregation="avg",
    ...
    # The local dataset maps stored raw commanded targets into the published
    # canonical [-1,1] codec. Keep that representation exact here.
