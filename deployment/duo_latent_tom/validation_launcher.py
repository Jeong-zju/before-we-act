...
from .common import POLICY_CONTRACT, TASKS, atomic_json
...
def main() -> None:
    ...
    while pending or active:
        while pending and len(active) < args.workers:
            ...
            command = ["/venv/main/bin/python", "-u", "-m", "deployment.duo_latent_tom.evaluate", "--checkpoint", str(args.checkpoint), "--data", str(args.data), "--output", str(args.output), "--task", task, "--episodes", str(args.episodes)]
