...
def main() -> None:
    ...
    result = {
        ...
        "action_cache_protocol": dataset.metadata.get("protocol_variant"),
        "action_history_lag": dataset.metadata.get("action_history_lag"),
        "cold_start_steps": dataset.metadata.get("cold_start_steps"),
        "cold_start_padding": dataset.metadata.get("cold_start_padding"),
        "cache_train_windows": dataset.metadata.get("train_windows"),
        "cache_validation_windows": dataset.metadata.get("validation_windows"),
