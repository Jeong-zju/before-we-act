"""Cached, paired data projection for the frozen Step 3-N2 experiment."""
...
from before_we_act.b3_n1_data import FUTURE_OFFSETS, N1Episode, N1Request
from before_we_act.b3_n1_r1 import R1OracleDataset
...
class B3N2Dataset(R1OracleDataset):
...
class B3N2PairedBatchSampler(Sampler[list[N1Request]]):
