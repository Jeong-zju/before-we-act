"""Train one four-phase R1-5 deployment-legal student and direct control."""
...
from before_we_act.b3_n1_model import masked_mse
...
def main() -> None:
    ...
    if contract.get("status") != "FROZEN_BEFORE_F0_F1" or args.seed not in R1_SEEDS:
