"""Masked, separately reported predictive team-belief objectives."""
...
from before_we_act.team_belief.predictive_core import FUTURE_OFFSETS_SECONDS
...
def compute_team_belief_losses(
    ...
    *,
    swapped_output: TeamBeliefPolicyOutput | None = None,
...
__all__ = ["TeamBeliefLossWeights", "compute_team_belief_losses"]
