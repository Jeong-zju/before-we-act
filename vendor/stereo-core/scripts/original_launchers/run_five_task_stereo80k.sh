#!/usr/bin/env bash
set -euo pipefail
export CUDA_VISIBLE_DEVICES=1 OMP_NUM_THREADS=12 MKL_NUM_THREADS=12
...
exec /workspace/venvs/robofactory-act/bin/python3.10 -u /workspace/act_liftbarrier/train_stereo_act.py \
  ...
  --output runs/strict640x480_v2/results/stereo_cross_relbias_all5_80k
